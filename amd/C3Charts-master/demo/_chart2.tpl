...
<head>
    ...
    <link rel="stylesheet" href="/demo/c3js/css/c3.min.css">
...
<!-- [[BEGIN CHART HTML]]-->
<div class="chart row">
    <div id="chart1" class="col-md-6" style="min-height: 300px;"></div>
    <div id="chart2" class="col-md-6" style="min-height: 300px;"></div>
</div>
<!-- [[END CHART HTML]]-->
        </div>
        <div class="col-md-4">
...
<!-- [[BEGIN CHART HTML]]-->
<script>
    var chart1 = c3.generate(<?php echo $oChart1->getC3('#chart1'); ?>);
    var chart2 = c3.generate(<?php echo $oChart2->getC3('#chart2'); ?>);
</script>
<!-- [[END CHART HTML]]-->
